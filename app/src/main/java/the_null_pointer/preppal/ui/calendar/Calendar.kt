...
private val events = generateEvents().groupBy { it.start.toLocalDate() }
...
@Composable
private fun LazyItemScope.EventInformation(event: UiEvent) {
    Row(
        modifier = Modifier
            .fillParentMaxWidth()
...
@Composable
private fun EventDetails(uiEvent: UiEvent) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .fillMaxHeight(),
